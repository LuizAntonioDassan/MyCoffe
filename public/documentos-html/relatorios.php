...
<body>
    ...
    <div class="card mb-4 p-3">
      ...
      <div class="d-flex flex-column flex-md-row justify-content-center align-items-center mb-1">
        <a href="#"><button class="btn mb-2 mx-2 mb-md-0">Gerar relatório de vendas</button></a>
        <a href="#"><button class="btn mb-2 mx-2 mb-md-0">Gerar relatório de produtos</button></a>
      </div>
    </div>
