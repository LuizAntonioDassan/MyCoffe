    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-2">
            ...
            <div class="col">
              <button type="button" class="btn btn-secondary btn-lg w-100" id="cadastroCargo">Registrar
                Cargo</button>
            </div>
            <div class="col">
              <button type="button" class="btn btn-secondary btn-lg w-100" id="cadastroPermissao">Registrar
                Permissão</button>
            </div>
            <div class="col">
              <button type="button" class="btn btn-secondary btn-lg w-100" id="listaCargos">Lista
                Cargos</button>
            </div>
          </div>
