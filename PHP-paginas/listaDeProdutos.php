...
<body>
    ...
    <main class="container">
                ...
                <div class="col-md-6">
                    <div class="dropdown py-2">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Preço (Ordem crescente)</a></li>
                            <li><a class="dropdown-item" href="#">Preço (Ordem decrescente)</a></li>
                            <li><a class="dropdown-item" href="#">Quantidade (Ordem crescente)</a></li>
                            <li><a class="dropdown-item" href="#">Quantidade (Ordem decrescente)</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <section class="row">
            ...
            <?php include "../PHP-componentes/cardListaDeProdutos.php" ?>
            <!-- Fim dos cards da lista de produtos -->
